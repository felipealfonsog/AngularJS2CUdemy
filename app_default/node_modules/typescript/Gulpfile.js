System.register(["child_process", "path", "fs", "gulp", "gulp-help", "run-sequence", "gulp-concat", "gulp-clone", "gulp-newer", "gulp-typescript", "gulp-insert", "gulp-sourcemaps", "del", "mkdirp", "minimist", "browserify", "through2", "merge2", "into-stream", "os", "travis-fold", "convert-source-map", "sorcery"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var cp, path, fs, originalGulp, helpMaker, runSequence, concat, clone, newer, tsc, insert, sourcemaps, del, mkdirP, minimist, browserify, through2, merge2, intoStream, os, fold, convertMap, sorcery;
    var gulp, mochaParallel, runTestsInParallel, cmdLineOptions, useDebugMode, host, compilerDirectory, harnessDirectory, libraryDirectory, scriptsDirectory, docDirectory, builtDirectory, builtLocalDirectory, LKGDirectory, copyright, compilerFilename, LKGCompiler, builtLocalCompiler, nodeModulesPathPrefix, isWin, mocha, es2015LibrarySources, es2015LibrarySourceMap, es2016LibrarySource, es2016LibrarySourceMap, es2017LibrarySource, es2017LibrarySourceMap, hostsLibrarySources, librarySourceMap, libraryTargets, configureNightlyJs, configureNightlyTs, packageJson, programTs, importDefinitelyTypedTestsDirectory, importDefinitelyTypedTestsJs, importDefinitelyTypedTestsTs, processDiagnosticMessagesJs, processDiagnosticMessagesTs, diagnosticMessagesJson, diagnosticInfoMapTs, generatedDiagnosticMessagesJSON, builtGeneratedDiagnosticMessagesJSON, servicesFile, standaloneDefinitionsFile, nodePackageFile, nodeDefinitionsFile, nodeStandaloneDefinitionsFile, copyrightContent, serverFile, tsserverLibraryFile, tsserverLibraryDefinitionFile, word2mdJs, word2mdTs, specWord, specMd, run, internalTests, localBaseline, refBaseline, localRwcBaseline, refRwcBaseline, localTest262Baseline, savedNodeEnv, testTimeout, nodeServerOutFile, nodeServerInFile, webhostPath, webhostJsPath, perftscPath, perftscJsPath, loggedIOpath, loggedIOJsPath, instrumenterPath, instrumenterJsPath, lintTargets;
    ...
    return {
        setters:[
            ...
            function (originalGulp_1) {
                originalGulp = originalGulp_1;
            },
            function (helpMaker_1) {
                helpMaker = helpMaker_1;
            },
            function (runSequence_1) {
                runSequence = runSequence_1;
            },
            function (concat_1) {
                concat = concat_1;
            },
            ...
            function (sourcemaps_1) {
                sourcemaps = sourcemaps_1;
            },
            function (del_1) {
                del = del_1;
            },
            ...
            function (browserify_1) {
                browserify = browserify_1;
            },
            function (through2_1) {
                through2 = through2_1;
            },
            ...
            function (intoStream_1) {
                intoStream = intoStream_1;
            },
            function (os_1) {
                os = os_1;
            },
            ...
            function (convertMap_1) {
                convertMap = convertMap_1;
            },
            function (sorcery_1) {
                sorcery = sorcery_1;
            }],
        execute: function() {
            ...
            mochaParallel = require("./scripts/mocha-parallel.js");
            runTestsInParallel = mochaParallel.runTestsInParallel;
            cmdLineOptions = minimist(process.argv.slice(2), {
            ...
            // Constants
            compilerDirectory = "src/compiler/";
            harnessDirectory = "src/harness/";
            libraryDirectory = "src/lib/";
            scriptsDirectory = "scripts/";
            docDirectory = "doc/";
            builtDirectory = "built/";
            builtLocalDirectory = "built/local/";
            LKGDirectory = "lib/";
            copyright = "CopyrightNotice.txt";
            compilerFilename = "tsc.js";
            LKGCompiler = path.join(LKGDirectory, compilerFilename);
            builtLocalCompiler = path.join(builtLocalDirectory, compilerFilename);
            nodeModulesPathPrefix = path.resolve("./node_modules/.bin/");
            isWin = /^win/.test(process.platform);
            mocha = path.join(nodeModulesPathPrefix, "mocha") + (isWin ? ".cmd" : "");
            es2015LibrarySources = [
                "es2015.core.d.ts",
            ...
            es2015LibrarySourceMap = es2015LibrarySources.map(function (source) {
                return { target: "lib." + source, sources: ["header.d.ts", source] };
            });
            es2016LibrarySource = ["es2016.array.include.d.ts"];
            es2016LibrarySourceMap = es2016LibrarySource.map(function (source) {
                return { target: "lib." + source, sources: ["header.d.ts", source] };
            });
            es2017LibrarySource = [
                "es2017.object.d.ts",
            ...
            es2017LibrarySourceMap = es2017LibrarySource.map(function (source) {
                return { target: "lib." + source, sources: ["header.d.ts", source] };
            });
            hostsLibrarySources = ["dom.generated.d.ts", "webworker.importscripts.d.ts", "scripthost.d.ts"];
            librarySourceMap = [
                // Host library
            ...
            libraryTargets = librarySourceMap.map(function (f) {
            ...
            configureNightlyJs = path.join(scriptsDirectory, "configureNightly.js");
            configureNightlyTs = path.join(scriptsDirectory, "configureNightly.ts");
            packageJson = "package.json";
            programTs = path.join(compilerDirectory, "program.ts");
            ...
            importDefinitelyTypedTestsDirectory = path.join(scriptsDirectory, "importDefinitelyTypedTests");
            importDefinitelyTypedTestsJs = path.join(importDefinitelyTypedTestsDirectory, "importDefinitelyTypedTests.js");
            importDefinitelyTypedTestsTs = path.join(importDefinitelyTypedTestsDirectory, "importDefinitelyTypedTests.ts");
            ...
            processDiagnosticMessagesJs = path.join(scriptsDirectory, "processDiagnosticMessages.js");
            processDiagnosticMessagesTs = path.join(scriptsDirectory, "processDiagnosticMessages.ts");
            diagnosticMessagesJson = path.join(compilerDirectory, "diagnosticMessages.json");
            diagnosticInfoMapTs = path.join(compilerDirectory, "diagnosticInformationMap.generated.ts");
            generatedDiagnosticMessagesJSON = path.join(compilerDirectory, "diagnosticMessages.generated.json");
            builtGeneratedDiagnosticMessagesJSON = path.join(builtLocalDirectory, "diagnosticMessages.generated.json");
            ...
            servicesFile = path.join(builtLocalDirectory, "typescriptServices.js");
            standaloneDefinitionsFile = path.join(builtLocalDirectory, "typescriptServices.d.ts");
            nodePackageFile = path.join(builtLocalDirectory, "typescript.js");
            nodeDefinitionsFile = path.join(builtLocalDirectory, "typescript.d.ts");
            nodeStandaloneDefinitionsFile = path.join(builtLocalDirectory, "typescript_standalone.d.ts");
            ...
            serverFile = path.join(builtLocalDirectory, "tsserver.js");
            ...
            tsserverLibraryFile = path.join(builtLocalDirectory, "tsserverlibrary.js");
            tsserverLibraryDefinitionFile = path.join(builtLocalDirectory, "tsserverlibrary.d.ts");
            ...
            word2mdJs = path.join(scriptsDirectory, "word2md.js");
            word2mdTs = path.join(scriptsDirectory, "word2md.ts");
            specWord = path.join(docDirectory, "TypeScript Language Specification.docx");
            specMd = path.join(docDirectory, "spec.md");
            ...
            run = path.join(builtLocalDirectory, "run.js");
            ...
            internalTests = "internal/";
            localBaseline = "tests/baselines/local/";
            refBaseline = "tests/baselines/reference/";
            localRwcBaseline = path.join(internalTests, "baselines/rwc/local");
            refRwcBaseline = path.join(internalTests, "baselines/rwc/reference");
            localTest262Baseline = path.join(internalTests, "baselines/test262/local");
            ...
            nodeServerOutFile = "tests/webTestServer.js";
            nodeServerInFile = "tests/webTestServer.ts";
            ...
            // Webhost
            webhostPath = "tests/webhost/webtsc.ts";
            webhostJsPath = "tests/webhost/webtsc.js";
            ...
            // Perf compiler
            perftscPath = "tests/perftsc.ts";
            perftscJsPath = "built/local/perftsc.js";
            ...
            loggedIOpath = path.join(harnessDirectory, "loggedIO.ts");
            loggedIOJsPath = path.join(builtLocalDirectory, "loggedIO.js");
            ...
            instrumenterPath = path.join(harnessDirectory, "instrumenter.ts");
            instrumenterJsPath = path.join(builtLocalDirectory, "instrumenter.js");
